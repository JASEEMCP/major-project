import 'package:app/domain/explorer/club_profile_model/club_profile_model.dart';
...
ClubProfileModel? _universityProfileModel;
    ...
    try {
      if (_universityProfileModel != null) {
        _textController[0].text =
            _universityProfileModel?.authorityName ?? 'N/A';
        _textController[1].text = _universityProfileModel?.clubEmail ?? 'N/A';
        _textController[2].text = _universityProfileModel?.authorName ?? 'N/A';
        return;
      }
      _isLoading.value = true;
      final response = await dioClient.dio
          .get('${Env().apiBaseUrl}/home/club/manage-profile/');
      if (response.statusCode == 200) {
        _isLoading.value = false;
        _universityProfileModel = ClubProfileModel.fromJson(response.data);
